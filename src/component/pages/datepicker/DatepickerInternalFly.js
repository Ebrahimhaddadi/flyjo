...
import {dateInternalfly, retundateifly} from '../../../redux/action/index';
...
const DatepickerInternalFly = (props) => {
  const { navigation,navigate } = props;
  console.log(props)
  const dispatch=useDispatch();
   
  const btnselect = () => {
    navigation.navigate("Ifly")
  }

 const  onDateChange=(date)=>{
   dispatch(dateInternalfly(date));
  }
...
export default DatepickerInternalFly;
