...
import {returndateefly} from '../../../redux/action/index';
...
const DatePickerReturnExtrnalFly = (props) => {
  const { navigation,navigate } = props;
  console.log(props)
  const dispatch=useDispatch();
   
  const btnselect = () => {
    navigation.navigate("Efly")
  }

 const  onDateChange=(date)=>{
   dispatch(returndateefly(date));
  }
...
export default DatePickerReturnExtrnalFly;
